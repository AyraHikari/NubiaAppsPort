...
.field g:Landroid/support/v7/widget/GridLayoutManager$b;
...
.method private L()V
    ...
    .line 192
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->f()I
...
.method private a(Landroid/view/View;IZ)V
    ...
    .line 723
    iget-object v3, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;
    ...
    .line 728
    iget-object v2, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;

    invoke-virtual {v2}, Landroid/support/v7/widget/h;->f()I
...
.method a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;III)Landroid/view/View;
    ...
    .line 419
    iget-object v0, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)Landroid/view/View;
    ...
    invoke-direct {v0, v1, v2, v4}, Landroid/support/v7/widget/GridLayoutManager;->a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;I)I
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/v7/widget/GridLayoutManager;->a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;I)I
    ...
    .line 1064
    iget v15, v4, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->a:I
    ...
    .line 1100
    iget v12, v4, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->a:I
    ...
    .line 1105
    :cond_15
    iget v8, v4, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->a:I
...
.method public a(Landroid/support/v7/widget/GridLayoutManager$b;)V
    ...
    .prologue
    .line 261
    iput-object p1, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Landroid/support/v7/widget/GridLayoutManager$b;
...
.method a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/LinearLayoutManager$b;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/h;->i()I
    ...
    invoke-direct {p0, v0, v1, v3}, Landroid/support/v7/widget/GridLayoutManager;->c(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;I)I
    ...
    .line 574
    invoke-direct/range {v2 .. v7}, Landroid/support/v7/widget/GridLayoutManager;->a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;IIZ)V
    ...
    invoke-virtual {v2, v9}, Landroid/support/v7/widget/h;->e(Landroid/view/View;)I
    ...
    iget-object v13, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;

    invoke-virtual {v13, v9}, Landroid/support/v7/widget/h;->f(Landroid/view/View;)I
    ...
    .line 612
    iget-object v6, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;

    invoke-virtual {v6, v2}, Landroid/support/v7/widget/h;->e(Landroid/view/View;)I
    ...
    invoke-virtual {v2, v7}, Landroid/support/v7/widget/h;->e(Landroid/view/View;)I
    ...
    .line 674
    iget-object v4, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/h;

    invoke-virtual {v4, v7}, Landroid/support/v7/widget/h;->f(Landroid/view/View;)I
...
.method public a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;Landroid/view/View;Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    .line 151
    invoke-virtual {v6}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->f()I
...
.method a(Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/RecyclerView$h$a;)V
    ...
    .line 515
    iget-object v4, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Landroid/support/v7/widget/GridLayoutManager$b;
