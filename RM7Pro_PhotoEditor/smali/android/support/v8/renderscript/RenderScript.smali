...
.method private static internalCreate(Landroid/content/Context;ILandroid/support/v8/renderscript/RenderScript$ContextType;I)Landroid/support/v8/renderscript/RenderScript;
    ...
    new-instance v8, Landroid/support/v8/renderscript/RenderScript;

    invoke-direct {v8, p0}, Landroid/support/v8/renderscript/RenderScript;-><init>(Landroid/content/Context;)V
    ...
    sput-object v1, Landroid/support/v8/renderscript/RenderScript;->registerNativeFree:Ljava/lang/reflect/Method;
    ...
    :try_start_3
    iget-object v1, v8, Landroid/support/v8/renderscript/RenderScript;->mNativeLibDir:Ljava/lang/String;
    ...
    iget-object v7, v8, Landroid/support/v8/renderscript/RenderScript;->mNativeLibDir:Ljava/lang/String;
    ...
    sput v1, Landroid/support/v8/renderscript/RenderScript;->sPointerSize:I
    :try_end_3
    ...
    iget-object v2, v8, Landroid/support/v8/renderscript/RenderScript;->mNativeLibDir:Ljava/lang/String;
    ...
    invoke-virtual {v8, v1, p0, v2}, Landroid/support/v8/renderscript/RenderScript;->nLoadSO(ZILjava/lang/String;)Z
    ...
    :try_start_5
    iget-object v0, v8, Landroid/support/v8/renderscript/RenderScript;->mNativeLibDir:Ljava/lang/String;
    ...
    :goto_6
    invoke-virtual {v8, v6, p0, v2}, Landroid/support/v8/renderscript/RenderScript;->nLoadSO(ZILjava/lang/String;)Z
    ...
    invoke-virtual {v8}, Landroid/support/v8/renderscript/RenderScript;->nLoadIOSO()Z
    ...
    iput-boolean v5, v8, Landroid/support/v8/renderscript/RenderScript;->mEnableMultiInput:Z
    ...
    :cond_d
    :goto_9
    invoke-virtual {v8}, Landroid/support/v8/renderscript/RenderScript;->nDeviceCreate()J
    ...
    iput-wide v0, v8, Landroid/support/v8/renderscript/RenderScript;->mContext:J

    iput-object p2, v8, Landroid/support/v8/renderscript/RenderScript;->mContextType:Landroid/support/v8/renderscript/RenderScript$ContextType;

    iput p3, v8, Landroid/support/v8/renderscript/RenderScript;->mContextFlags:I

    iput p1, v8, Landroid/support/v8/renderscript/RenderScript;->mContextSdkVersion:I

    iput p0, v8, Landroid/support/v8/renderscript/RenderScript;->mDispatchAPILevel:I
    ...
    invoke-direct {p0, v8}, Landroid/support/v8/renderscript/RenderScript$MessageThread;-><init>(Landroid/support/v8/renderscript/RenderScript;)V

    iput-object p0, v8, Landroid/support/v8/renderscript/RenderScript;->mMessageThread:Landroid/support/v8/renderscript/RenderScript$MessageThread;
...
.method private static setupNative(ILandroid/content/Context;)Z
    ...
    const-string v2, "com.android.support.v8.renderscript.EnableAsyncTeardown"
