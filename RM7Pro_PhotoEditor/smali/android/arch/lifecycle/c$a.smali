.class synthetic Landroid/arch/lifecycle/c$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/c$a;->b:[I

    const/4 v1, 0x1

    :try_start_0
    sget-object v2, Landroid/arch/lifecycle/a$b;->b:Landroid/arch/lifecycle/a$b;
    ...
    :try_start_1
    sget-object v2, Landroid/arch/lifecycle/c$a;->b:[I

    sget-object v3, Landroid/arch/lifecycle/a$b;->c:Landroid/arch/lifecycle/a$b;
    ...
    :try_start_2
    sget-object v3, Landroid/arch/lifecycle/c$a;->b:[I

    sget-object v4, Landroid/arch/lifecycle/a$b;->d:Landroid/arch/lifecycle/a$b;
    ...
    :try_start_3
    sget-object v4, Landroid/arch/lifecycle/c$a;->b:[I

    sget-object v5, Landroid/arch/lifecycle/a$b;->e:Landroid/arch/lifecycle/a$b;
    ...
    :try_start_4
    sget-object v5, Landroid/arch/lifecycle/c$a;->b:[I

    sget-object v6, Landroid/arch/lifecycle/a$b;->a:Landroid/arch/lifecycle/a$b;
    ...
    sput-object v5, Landroid/arch/lifecycle/c$a;->a:[I
    ...
    :catch_5
    :try_start_6
    sget-object v1, Landroid/arch/lifecycle/c$a;->a:[I
