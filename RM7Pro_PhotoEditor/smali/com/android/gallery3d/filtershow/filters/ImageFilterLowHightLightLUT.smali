.class public Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->a:Landroid/content/res/Resources;

    const v1, 0x7f07011a

    iput v1, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->b:I

    iput-object v0, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->c:Landroid/graphics/Bitmap;

    const-string v0, "LowHightLightLUT"
...
.method public apply(Landroid/graphics/Bitmap;FI)Landroid/graphics/Bitmap;
    ...
    iget-object p2, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->c:Landroid/graphics/Bitmap;
    ...
    iget p3, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->b:I

    if-eqz p3, :cond_0

    iget-object v0, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->a:Landroid/content/res/Resources;
    ...
    iput-object p2, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->c:Landroid/graphics/Bitmap;
    ...
    const-string p3, "ImageFilterLowHightLightLUT"
    ...
    iget-object v4, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->c:Landroid/graphics/Bitmap;

    move-object v0, p0

    move-object v1, p1

    invoke-virtual/range {v0 .. v7}, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->nativeApplyFilter(Landroid/graphics/Bitmap;IILandroid/graphics/Bitmap;IIF)V
...
.method public d(Landroid/content/res/Resources;)V
    ...
    iput-object p1, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->a:Landroid/content/res/Resources;
...
.method public freeResources()V
    ...
    iget-object v0, p0, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;->c:Landroid/graphics/Bitmap;
...
.method public getDefaultRepresentation()Lcom/android/gallery3d/filtershow/filters/x;
    ...
    const-string v1, "LowHightLightLUT"
    ...
    const-class v1, Lcom/android/gallery3d/filtershow/filters/ImageFilterLowHightLightLUT;
