.class Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;
...
.method private constructor <init>(Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;)V
    ...
    .prologue
    .line 978
    iput-object p1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->this$0:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;
...
.method constructor <init>(Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$1;)V
    ...
    .prologue
    .line 978
    invoke-direct {p0, p1}, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;-><init>(Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;)V
...
.method advance()V
    ...
    .prologue
    .line 980
    iget-object v1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->this$0:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;
    ...
    .line 983
    :try_start_0
    iget-object v1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->next:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$Node;

    if-nez v1, :cond_0

    iget-object v1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->this$0:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;

    invoke-static {v1}, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;->access$400(Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque;)Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$Node;

    move-result-object v1

    :goto_0
    iput-object v1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->next:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$Node;
    ...
    :goto_1
    iput-object v1, p0, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$DescendingItr;->nextItem:Ljava/lang/Object;
    :try_end_0
    ...
    iget-object v1, v1, Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$Node;->prev:Ledu/emory/mathcs/backport/java/util/concurrent/LinkedBlockingDeque$Node;
