.class public Lcn/nubia/calendar/util/PermissionRequestUtil;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/nubia/calendar/util/PermissionRequestUtil$PermissionRequestCallback;
    }
.end annotation
...
.method public static requestPackagePermission(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0, v1}, Lcn/nubia/calendar/util/PermissionRequestUtil;->requestPackagePermission(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public static requestPackagePermission(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {p0, p1, p2, v0}, Lcn/nubia/calendar/util/PermissionRequestUtil;->requestPackagePermission(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;Lcn/nubia/calendar/util/PermissionRequestUtil$PermissionRequestCallback;)I
...
.method public static requestPackagePermission(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;Lcn/nubia/calendar/util/PermissionRequestUtil$PermissionRequestCallback;)I
    .locals 5
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "packagename"    # Ljava/lang/String;
    .param p2, "permissions"    # [Ljava/lang/String;
    .param p3, "permissionRequestCallback"    # Lcn/nubia/calendar/util/PermissionRequestUtil$PermissionRequestCallback;
    ...
    .line 29
    :cond_0
    invoke-static {p0, p1}, Lcn/nubia/calendar/util/PermissionRequestUtil;->enforceArguments(Landroid/content/Context;Ljava/lang/String;)V

    .line 30
    invoke-static {p0, p1, p2}, Lcn/nubia/calendar/util/PermissionRequestUtil;->realRequestPackagePermission(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 34
    invoke-interface {p3, v1}, Lcn/nubia/calendar/util/PermissionRequestUtil$PermissionRequestCallback;->onRequestResult(Landroid/os/Bundle;)V
...
.method public static requestPackagePermissionWithResult(Landroid/content/Context;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v0, v1}, Lcn/nubia/calendar/util/PermissionRequestUtil;->requestPackagePermissionWithResult(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)Landroid/os/Bundle;
