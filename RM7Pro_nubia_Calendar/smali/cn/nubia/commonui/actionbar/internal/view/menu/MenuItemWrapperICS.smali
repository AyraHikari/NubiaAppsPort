.class public Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;
.super Lcn/nubia/commonui/actionbar/internal/view/menu/BaseMenuWrapper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;,
        Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;,
        Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$OnActionExpandListenerWrapper;,
        Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;
    }
.end annotation

.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcn/nubia/commonui/actionbar/internal/view/menu/BaseMenuWrapper",
        "<",
...
# static fields
.field static final LOG_TAG:Ljava/lang/String; = "NubiaWidget"
...
.method constructor <init>(Landroid/content/Context;Landroid/support/v4/internal/view/SupportMenuItem;)V
    ...
    .prologue
    .line 49
    invoke-direct {p0, p1, p2}, Lcn/nubia/commonui/actionbar/internal/view/menu/BaseMenuWrapper;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public collapseActionView()Z
    ...
    .prologue
    .line 281
    iget-object v0, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
...
.method createActionProviderWrapper(Landroid/view/ActionProvider;)Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;
    .locals 2
    .param p1, "provider"    # Landroid/view/ActionProvider;

    .prologue
    .line 309
    new-instance v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    iget-object v1, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;-><init>(Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;Landroid/content/Context;Landroid/view/ActionProvider;)V
...
.method public getActionProvider()Landroid/view/ActionProvider;
    ...
    .prologue
    .line 267
    iget-object v1, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
    ...
    instance-of v1, v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    if-eqz v1, :cond_0

    .line 269
    check-cast v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    .end local v0    # "provider":Landroid/support/v4/view/ActionProvider;
    iget-object v1, v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;->mInner:Landroid/view/ActionProvider;
...
.method public getActionView()Landroid/view/View;
    ...
    instance-of v1, v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    if-eqz v1, :cond_0

    .line 253
    check-cast v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    .end local v0    # "actionView":Landroid/view/View;
    invoke-virtual {v0}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;->getWrappedView()Landroid/view/View;
...
.method public getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {p0, v0}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->getSubMenuWrapper(Landroid/view/SubMenu;)Landroid/view/SubMenu;
...
.method public setActionProvider(Landroid/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    .line 261
    invoke-virtual {p0, p1}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->createActionProviderWrapper(Landroid/view/ActionProvider;)Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$ActionProviderWrapper;
...
.method public setActionView(I)Landroid/view/MenuItem;
    ...
    new-instance v2, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    invoke-direct {v2, v0}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;-><init>(Landroid/view/View;)V
...
.method public setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 230
    new-instance v0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    invoke-direct {v0, p1}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;-><init>(Landroid/view/View;)V
...
.method public setExclusiveCheckable(Z)V
    ...
    .line 298
    :try_start_0
    iget-object v1, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;
    ...
    iput-object v1, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;

    .line 302
    :cond_0
    iget-object v1, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;

    iget-object v2, p0, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
...
.method public setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;

    invoke-direct {v1, p0, p1}, Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;-><init>(Lcn/nubia/commonui/actionbar/internal/view/menu/MenuItemWrapperICS;Landroid/view/MenuItem$OnMenuItemClickListener;)V
