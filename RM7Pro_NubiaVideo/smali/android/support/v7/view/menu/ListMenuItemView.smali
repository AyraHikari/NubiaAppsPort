...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, La/b/d/a/j;->i1:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Landroid/support/v7/widget/r0;->s(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/r0;

    move-result-object p2

    .line 4
    sget p3, La/b/d/a/j;->k1:I

    invoke-virtual {p2, p3}, Landroid/support/v7/widget/r0;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    sget p3, La/b/d/a/j;->j1:I

    const/4 v0, -0x1

    invoke-virtual {p2, p3, v0}, Landroid/support/v7/widget/r0;->l(II)I
    ...
    .line 6
    sget p3, La/b/d/a/j;->l1:I

    invoke-virtual {p2, p3, v2}, Landroid/support/v7/widget/r0;->a(IZ)Z
...
.method private a(Landroid/view/View;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/view/menu/ListMenuItemView;->c(Landroid/view/View;I)V
...
.method private f()V
    ...
    .line 3
    invoke-direct {p0, v0, v2}, Landroid/support/v7/view/menu/ListMenuItemView;->c(Landroid/view/View;I)V
...
.method public b(Landroid/support/v7/view/menu/h;I)V
    ...
    .line 5
    invoke-virtual {p1}, Landroid/support/v7/view/menu/h;->y()Z

    move-result p2

    invoke-virtual {p1}, Landroid/support/v7/view/menu/h;->e()C

    move-result v0

    invoke-virtual {p0, p2, v0}, Landroid/support/v7/view/menu/ListMenuItemView;->h(ZC)V
...
.method public h(ZC)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->f()Ljava/lang/String;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->x()Z
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ListMenuItemView;->m:Z
    ...
    .line 4
    invoke-direct {p0}, Landroid/support/v7/view/menu/ListMenuItemView;->f()V
