...
.method private a()Landroid/support/v7/view/menu/k;
    .locals 14
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/k;->l(Landroid/support/v7/view/menu/g;)V

    .line 12
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/k;->u(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 13
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/k;->p(Landroid/view/View;)V

    .line 14
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->i:Landroid/support/v7/view/menu/m$a;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/m;->f(Landroid/support/v7/view/menu/m$a;)V

    .line 15
    iget-boolean v1, p0, Landroid/support/v7/view/menu/l;->h:Z

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/k;->r(Z)V

    .line 16
    iget v1, p0, Landroid/support/v7/view/menu/l;->g:I

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/k;->s(I)V
...
.method private l(IIZZ)V
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/l;->c()Landroid/support/v7/view/menu/k;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/k;->v(Z)V
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/k;->t(I)V

    .line 8
    invoke-virtual {v0, p2}, Landroid/support/v7/view/menu/k;->w(I)V
    ...
    .line 11
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/k;->q(Landroid/graphics/Rect;)V
...
.method public b()V
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/l;->d()Z
...
.method public c()Landroid/support/v7/view/menu/k;
    .locals 1
    ...
    .line 2
    invoke-direct {p0}, Landroid/support/v7/view/menu/l;->a()Landroid/support/v7/view/menu/k;
...
.method public g(Z)V
    ...
    .line 3
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/k;->r(Z)V
...
.method public j(Landroid/support/v7/view/menu/m$a;)V
    .locals 1
    ...
    .line 3
    invoke-interface {v0, p1}, Landroid/support/v7/view/menu/m;->f(Landroid/support/v7/view/menu/m$a;)V
...
.method public k()V
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/l;->m()Z
...
.method public m()Z
    ...
    .line 3
    :cond_1
    invoke-direct {p0, v2, v2, v2, v2}, Landroid/support/v7/view/menu/l;->l(IIZZ)V
...
.method public n(II)Z
    ...
    .line 3
    :cond_1
    invoke-direct {p0, p1, p2, v1, v1}, Landroid/support/v7/view/menu/l;->l(IIZZ)V
