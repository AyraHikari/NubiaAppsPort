...
.method public constructor <init>(Landroid/content/Context;IIIILjava/lang/CharSequence;)V
    ...
    .line 3
    iput p4, p0, Landroid/support/v7/view/menu/a;->j:I

    const/4 p4, 0x0

    .line 4
    iput-object p4, p0, Landroid/support/v7/view/menu/a;->o:Landroid/content/res/ColorStateList;

    .line 5
    iput-object p4, p0, Landroid/support/v7/view/menu/a;->p:Landroid/graphics/PorterDuff$Mode;

    const/4 p4, 0x0

    .line 6
    iput-boolean p4, p0, Landroid/support/v7/view/menu/a;->q:Z

    .line 7
    iput-boolean p4, p0, Landroid/support/v7/view/menu/a;->r:Z

    const/16 p4, 0x10

    .line 8
    iput p4, p0, Landroid/support/v7/view/menu/a;->s:I
    ...
    .line 12
    iput p5, p0, Landroid/support/v7/view/menu/a;->c:I

    .line 13
    iput-object p6, p0, Landroid/support/v7/view/menu/a;->d:Ljava/lang/CharSequence;
...
.method private a()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/a;->q:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/view/menu/a;->r:Z
...
.method public c(Landroid/view/View;)Landroid/support/v4/internal/view/SupportMenuItem;
    .locals 0
...
.method public d(I)Landroid/support/v4/internal/view/SupportMenuItem;
    .locals 0
...
.method public bridge synthetic setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/a;->c(Landroid/view/View;)Landroid/support/v4/internal/view/SupportMenuItem;
...
.method public setCheckable(Z)Landroid/view/MenuItem;
    ...
    iput p1, p0, Landroid/support/v7/view/menu/a;->s:I
...
.method public setIconTintList(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
    ...
    .line 2
    iput-boolean p1, p0, Landroid/support/v7/view/menu/a;->q:Z
...
.method public bridge synthetic setShowAsActionFlags(I)Landroid/view/MenuItem;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/a;->d(I)Landroid/support/v4/internal/view/SupportMenuItem;
