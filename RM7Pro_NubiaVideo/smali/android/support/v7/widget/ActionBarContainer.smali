...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 6
    sget p2, La/b/d/a/j;->d:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->f:Landroid/graphics/drawable/Drawable;
    ...
    .line 10
    sget p2, La/b/d/a/j;->c:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->g:Landroid/graphics/drawable/Drawable;
    ...
    .line 12
    iget-boolean p1, p0, Landroid/support/v7/widget/ActionBarContainer;->h:Z

    const/4 p2, 0x0

    if-eqz p1, :cond_1

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContainer;->g:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContainer;->f:Landroid/graphics/drawable/Drawable;
...
.method public onLayout(ZIIII)V
    ...
    .line 9
    :cond_1
    iget-boolean p2, p0, Landroid/support/v7/widget/ActionBarContainer;->h:Z
    ...
    .line 12
    :cond_3
    iget-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->e:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_6

    .line 13
    iget-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->c:Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/ActionBarContainer;->c:Landroid/view/View;

    invoke-virtual {p3}, Landroid/view/View;->getLeft()I

    move-result p3

    iget-object p4, p0, Landroid/support/v7/widget/ActionBarContainer;->c:Landroid/view/View;
    ...
    .line 17
    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->d:Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/ActionBarContainer;->d:Landroid/view/View;

    invoke-virtual {p3}, Landroid/view/View;->getLeft()I

    move-result p3

    iget-object p4, p0, Landroid/support/v7/widget/ActionBarContainer;->d:Landroid/view/View;
    ...
    .line 23
    :cond_6
    iput-boolean v1, p0, Landroid/support/v7/widget/ActionBarContainer;->i:Z

    if-eqz v1, :cond_2

    .line 24
    iget-object p2, p0, Landroid/support/v7/widget/ActionBarContainer;->f:Landroid/graphics/drawable/Drawable;
...
.method public onMeasure(II)V
    ...
    .line 6
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContainer;->c:Landroid/view/View;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarContainer;->b(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarContainer;->a(Landroid/view/View;)I
    ...
    .line 15
    invoke-direct {p0, v1}, Landroid/support/v7/widget/ActionBarContainer;->a(Landroid/view/View;)I
...
.method public setPrimaryBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContainer;->c:Landroid/view/View;
...
.method public setStackedBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 6
    iget-boolean p1, p0, Landroid/support/v7/widget/ActionBarContainer;->i:Z
...
.method public setTabContainer(Landroid/support/v7/widget/k0;)V
    .locals 2
    ...
    .line 8
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/k0;->setAllowCollapse(Z)V
...
.method public setVisibility(I)V
    ...
    .line 3
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContainer;->f:Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContainer;->g:Landroid/graphics/drawable/Drawable;
