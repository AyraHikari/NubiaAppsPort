.class Landroid/support/v7/widget/SearchView$p;
...
.method public a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    .line 3
    iget-object p1, p0, Landroid/support/v7/widget/SearchView$p;->d:Landroid/graphics/Rect;
    ...
    .line 4
    iget-object p1, p0, Landroid/support/v7/widget/SearchView$p;->c:Landroid/graphics/Rect;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 4
    :cond_0
    iget-boolean v2, p0, Landroid/support/v7/widget/SearchView$p;->f:Z

    .line 5
    iput-boolean v5, p0, Landroid/support/v7/widget/SearchView$p;->f:Z
    ...
    .line 7
    iget-object v6, p0, Landroid/support/v7/widget/SearchView$p;->d:Landroid/graphics/Rect;
    ...
    .line 8
    :cond_3
    iget-object v2, p0, Landroid/support/v7/widget/SearchView$p;->b:Landroid/graphics/Rect;
    ...
    .line 9
    iput-boolean v4, p0, Landroid/support/v7/widget/SearchView$p;->f:Z
    ...
    .line 10
    iget-object v2, p0, Landroid/support/v7/widget/SearchView$p;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView$p;->a:Landroid/view/View;
