...
.method private markFragmentsCreated()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/app/FragmentActivity;->markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/c$b;)Z
...
.method private static markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/c$b;)Z
    .locals 4
    ...
    invoke-virtual {v2}, Landroid/arch/lifecycle/c;->b()Landroid/arch/lifecycle/c$b;
    ...
    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/f;->k(Landroid/arch/lifecycle/c$b;)V
    ...
    .line 6
    invoke-static {v1, p1}, Landroid/support/v4/app/FragmentActivity;->markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/c$b;)Z
...
.method public getViewModelStore()Landroid/arch/lifecycle/p;
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/p;
    ...
    .line 4
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->viewModelStore:Landroid/arch/lifecycle/p;

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/p;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 4
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->viewModelStore:Landroid/arch/lifecycle/p;

    if-eqz v2, :cond_0

    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/p;

    if-nez v3, :cond_0

    .line 5
    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/p;
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/p;
    ...
    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->viewModelStore:Landroid/arch/lifecycle/p;
