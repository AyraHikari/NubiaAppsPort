...
.method private captureValues(Landroid/support/transition/TransitionValues;)V
    ...
    .line 63
    :cond_1
    invoke-static {v2}, Landroid/support/v4/view/ViewCompat;->getClipBounds(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-object v8, p2, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    iget-object v8, p3, Landroid/support/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    invoke-static {v8, v5}, Landroid/support/v4/view/ViewCompat;->setClipBounds(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 106
    new-instance v4, Landroid/support/transition/RectEvaluator;

    new-instance v8, Landroid/graphics/Rect;

    invoke-direct {v8}, Landroid/graphics/Rect;-><init>()V

    invoke-direct {v4, v8}, Landroid/support/transition/RectEvaluator;-><init>(Landroid/graphics/Rect;)V

    .line 107
    .local v4, "evaluator":Landroid/support/transition/RectEvaluator;
    iget-object v8, p3, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;

    sget-object v9, Landroid/support/transition/ViewUtils;->CLIP_BOUNDS:Landroid/util/Property;
    ...
    .end local v4    # "evaluator":Landroid/support/transition/RectEvaluator;
    :cond_4
    move v2, v7
