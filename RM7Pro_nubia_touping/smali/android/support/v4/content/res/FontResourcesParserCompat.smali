...
.method private static readFont(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;
    ...
    .line 254
    .local v1, "attrs":Landroid/util/AttributeSet;
    sget-object v10, Landroid/support/compat/R$styleable;->FontFamilyFont:[I

    invoke-virtual {p1, v1, v10}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    .line 255
    .local v0, "array":Landroid/content/res/TypedArray;
    sget v10, Landroid/support/compat/R$styleable;->FontFamilyFont_fontWeight:I
    ...
    .line 259
    .local v7, "weight":I
    sget v10, Landroid/support/compat/R$styleable;->FontFamilyFont_fontStyle:I
    ...
    .end local v4    # "resourceAttr":I
    .end local v5    # "resourceId":I
    .end local v6    # "styleAttr":I
    .end local v7    # "weight":I
    .end local v8    # "weightAttr":I
    :cond_0
    ...
    .restart local v8    # "weightAttr":I
    :cond_1
    sget v6, Landroid/support/compat/R$styleable;->FontFamilyFont_android_fontStyle:I

    goto :goto_1

    .restart local v6    # "styleAttr":I
    :cond_2
    move v3, v9
    ...
    :cond_3
    sget v4, Landroid/support/compat/R$styleable;->FontFamilyFont_android_font:I

    goto :goto_3

    .line 272
    .restart local v2    # "filename":Ljava/lang/String;
    .restart local v4    # "resourceAttr":I
    ...
    invoke-direct {v9, v2, v7, v3, v5}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;-><init>(Ljava/lang/String;IZI)V
