...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 97
    iput-boolean v4, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAligned:Z

    .line 106
    iput v6, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I

    .line 113
    iput v5, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineChildTop:I

    .line 117
    const v3, 0x800033

    iput v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mGravity:I

    .line 152
    sget-object v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat:[I

    invoke-static {p1, p2, v3, p3, v5}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;

    move-result-object v0

    .line 155
    .local v0, "a":Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_android_orientation:I

    invoke-virtual {v0, v3, v6}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getInt(II)I
    ...
    .line 157
    invoke-virtual {p0, v2}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->setOrientation(I)V

    .line 160
    :cond_0
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_android_gravity:I
    ...
    .line 162
    invoke-virtual {p0, v2}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->setGravity(I)V

    .line 165
    :cond_1
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_android_baselineAligned:I

    invoke-virtual {v0, v3, v4}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    .line 170
    :cond_2
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_android_weightSum:I

    const/high16 v4, -0x40800000    # -1.0f

    invoke-virtual {v0, v3, v4}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mWeightSum:F

    .line 172
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_android_baselineAlignedChildIndex:I
    ...
    iput v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I

    .line 175
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_measureWithLargestChild:I

    invoke-virtual {v0, v3, v5}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mUseLargestChild:Z

    .line 177
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_divider:I
    ...
    invoke-virtual {p0, v3}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 178
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_showDividers:I

    invoke-virtual {v0, v3, v5}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mShowDividers:I

    .line 179
    sget v3, Lcn/nubia/commonui/R$styleable;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {v0, v3, v5}, Lcn/nubia/commonui/actionbar/internal/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerPadding:I
...
.method private forceUniformHeight(II)V
    ...
    .line 1316
    invoke-virtual {p0, v6}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getVirtualChildAt(I)Landroid/view/View;
    ...
    check-cast v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 1320
    .local v7, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    iget v0, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    .line 1323
    iget v8, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    iput v0, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    .line 1328
    iput v8, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I

    .line 1315
    .end local v7    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
...
.method private forceUniformWidth(II)V
    ...
    .line 897
    .local v7, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    iget v0, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    .line 900
    iget v8, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    iput v0, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    .line 905
    iput v8, v7, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
...
.method drawDividersHorizontal(Landroid/graphics/Canvas;)V
    ...
    .line 321
    invoke-virtual {p0, v2}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getVirtualChildAt(I)Landroid/view/View;
    ...
    check-cast v4, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 327
    .local v4, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    if-eqz v3, :cond_1
    ...
    iget v7, v4, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->rightMargin:I
    ...
    .local v5, "position":I
    :goto_1
    invoke-virtual {p0, p1, v5}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->drawVerticalDivider(Landroid/graphics/Canvas;I)V

    .line 320
    .end local v4    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    ...
    .line 330
    .restart local v4    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    :cond_1
    invoke-virtual {v0}, Landroid/view/View;->getLeft()I

    move-result v6

    iget v7, v4, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I

    sub-int/2addr v6, v7

    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerWidth:I
...
.method drawDividersVertical(Landroid/graphics/Canvas;)V
    ...
    .line 293
    invoke-virtual {p0, v3}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getVirtualChildAt(I)Landroid/view/View;
    ...
    .line 296
    invoke-virtual {p0, v3}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->hasDividerBeforeChildAt(I)Z
    ...
    iget v7, v4, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I

    sub-int/2addr v6, v7

    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerHeight:I

    sub-int v5, v6, v7

    .line 299
    .local v5, "top":I
    invoke-virtual {p0, p1, v5}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->drawHorizontalDivider(Landroid/graphics/Canvas;I)V
    ...
    iget v7, v4, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->bottomMargin:I
...
.method public getBaseline()I
    ...
    .line 419
    iget v6, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I
    ...
    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I
    ...
    invoke-virtual {p0, v6}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getChildAt(I)Landroid/view/View;
    ...
    .line 448
    :cond_3
    iget v2, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineChildTop:I

    .line 450
    .local v2, "childTop":I
    iget v5, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mOrientation:I
    ...
    .line 451
    iget v5, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mGravity:I
    ...
    .line 467
    .local v3, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    ...
    .line 455
    .end local v3    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    ...
    iget v6, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mTotalLength:I
...
.method protected hasDividerBeforeChildAt(I)Z
    ...
    .line 562
    iget v4, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mShowDividers:I
...
.method layoutHorizontal(IIII)V
    ...
    iget-boolean v8, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAligned:Z
    ...
    invoke-virtual {v0, v11}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v11}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->measureNullChild(I)I
    ...
    iget v0, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mTotalLength:I
    ...
    check-cast v22, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 1580
    .local v22, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    if-eqz v8, :cond_3

    move-object/from16 v0, v22

    iget v2, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    iget v0, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->gravity:I
    ...
    invoke-virtual {v0, v11}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->hasDividerBeforeChildAt(I)Z
    ...
    iget v2, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I
    ...
    iget v2, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->rightMargin:I
    ...
    invoke-virtual {v0, v3, v11}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    iget v2, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I
    ...
    iget v4, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I

    add-int/2addr v2, v4

    move-object/from16 v0, v22

    iget v4, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->bottomMargin:I
    ...
    .end local v22    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    :cond_7
    return-void
...
.method layoutVertical(IIII)V
    ...
    iget v1, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mGravity:I
    ...
    invoke-virtual {v0, v13}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getVirtualChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v13}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->measureNullChild(I)I
    ...
    check-cast v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 1467
    .local v15, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    iget v12, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->gravity:I
    ...
    .line 1486
    iget v1, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I
    ...
    invoke-virtual {v0, v13}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->hasDividerBeforeChildAt(I)Z
    ...
    iget v1, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerHeight:I

    add-int/2addr v10, v1

    .line 1494
    :cond_3
    iget v1, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I
    ...
    invoke-virtual {v0, v2}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getLocationOffset(Landroid/view/View;)I
    ...
    invoke-direct/range {v1 .. v6}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->setChildFrame(Landroid/view/View;IIII)V

    .line 1497
    iget v1, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->bottomMargin:I

    add-int/2addr v1, v6

    move-object/from16 v0, p0

    invoke-virtual {v0, v2}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getNextLocationOffset(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v2, v13}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getChildrenSkipCount(Landroid/view/View;I)I
    ...
    iget v4, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I

    add-int/2addr v1, v4

    iget v4, v15, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->rightMargin:I
    ...
    .end local v15    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    :cond_4
    return-void
...
.method measureHorizontal(II)V
    ...
    iget-boolean v13, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAligned:Z
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerWidth:I
    ...
    check-cast v29, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 978
    .local v29, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    move-object/from16 v0, v29

    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->weight:F
    ...
    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I

    move-object/from16 v0, v29

    iget v7, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->rightMargin:I
    ...
    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I

    move-object/from16 v0, v29

    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->bottomMargin:I
    ...
    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->gravity:I
    ...
    iget v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I

    add-int v3, v3, v39

    move-object/from16 v0, v29

    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->rightMargin:I
    ...
    iput v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    iput v0, v1, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
    ...
    .end local v4    # "child":Landroid/view/View;
    .end local v16    # "childHeight":I
    .end local v29    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    .end local v30    # "margin":I
    .end local v32    # "matchHeightLocally":Z
    :cond_15
    move-object/from16 v0, p0
    ...
    .line 1127
    .restart local v29    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    if-eqz v27, :cond_1c
    ...
    iget v0, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mWeightSum:F
    ...
    iget v15, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->weight:F
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->topMargin:I
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I

    .line 1180
    move/from16 v0, p2

    invoke-static {v0, v3, v6}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->getChildMeasureSpec(III)I
    ...
    iget v7, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->leftMargin:I
    ...
    invoke-virtual {v0, v3, v6}, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->setMeasuredDimension(II)V
...
.method measureVertical(II)V
    ...
    iget v12, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mDividerHeight:I
    ...
    check-cast v23, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;

    .line 631
    .local v23, "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    ...
    iput v3, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    iput v0, v1, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->height:I
    ...
    .line 705
    invoke-static {v15, v3}, Lcn/nubia/commonui/actionbar/internal/widget/ViewUtils;->combineMeasuredStates(II)I
    ...
    .line 724
    .end local v4    # "child":Landroid/view/View;
    .end local v23    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    .end local v24    # "margin":I
    ...
    .line 748
    .restart local v23    # "lp":Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;
    move-object/from16 v0, p0
    ...
    iget v13, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->weight:F
    ...
    iget v6, v0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat$LayoutParams;->width:I
...
.method public setGravity(I)V
    ...
    .line 1684
    :cond_1
    iput p1, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mGravity:I
...
.method public setHorizontalGravity(I)V
    ...
    iput v1, p0, Lcn/nubia/commonui/actionbar/widget/LinearLayoutCompat;->mGravity:I
