...
const float k1=-1.1416988;
const float k2=0.559840421;
const float k3=-0.0270501;
const float k4=-1.1125477;
const float k5=0.50959248;
const float k6=0.0;
const float p1=0.001031292;
const float p2=-0.0009052912;
const float fx=1502.9191;
const float u0=1620.990;
const float fy=1502.91911;
const float v0=1217.345;
