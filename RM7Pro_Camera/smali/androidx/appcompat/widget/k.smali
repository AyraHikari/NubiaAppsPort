...
.method public static declared-synchronized a()V
    ...
    .line 54
    :try_start_0
    sget-object v1, Landroidx/appcompat/widget/k;->b:Landroidx/appcompat/widget/k;
    ...
    sput-object v1, Landroidx/appcompat/widget/k;->b:Landroidx/appcompat/widget/k;
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/k;->c:Landroidx/appcompat/widget/an;

    .line 57
    sget-object v1, Landroidx/appcompat/widget/k;->b:Landroidx/appcompat/widget/k;

    iget-object v1, v1, Landroidx/appcompat/widget/k;->c:Landroidx/appcompat/widget/an;

    new-instance v2, Landroidx/appcompat/widget/k$1;

    invoke-direct {v2}, Landroidx/appcompat/widget/k$1;-><init>()V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/an;->a(Landroidx/appcompat/widget/an$e;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/av;[I)V
    ...
    .line 433
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/an;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/av;[I)V
...
.method public declared-synchronized a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/an;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/an;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/an;->a(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/an;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
