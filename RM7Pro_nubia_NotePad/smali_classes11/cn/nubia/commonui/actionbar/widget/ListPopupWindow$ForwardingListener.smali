...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$TriggerLongPress;,
        Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$DisallowIntercept;
    }
.end annotation
...
.method static synthetic access$1000(Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;)V
    .locals 0
    .param p0, "x0"    # Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;
...
.method private onLongPress()V
    ...
    .line 1389
    iget-object v9, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mSrc:Landroid/view/View;
    ...
    .line 1409
    iput-boolean v10, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mForwarding:Z

    .line 1410
    iput-boolean v10, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mWasLongPress:Z
...
.method private onTouchForwarded(Landroid/view/MotionEvent;)Z
    ...
    .line 1420
    iget-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mSrc:Landroid/view/View;
    ...
    .line 1422
    .local v5, "popup":Lcn/nubia/commonui/actionbar/widget/ListPopupWindow;
    if-eqz v5, :cond_0

    invoke-virtual {v5}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow;->isShowing()Z
    ...
    .line 1426
    :cond_1
    invoke-static {v5}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow;->access$600(Lcn/nubia/commonui/actionbar/widget/ListPopupWindow;)Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$DropDownListView;

    move-result-object v1

    .line 1427
    .local v1, "dst":Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$DropDownListView;
    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$DropDownListView;->isShown()Z
    ...
    invoke-direct {p0, v6, v2}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->toGlobalMotionEvent(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 1434
    invoke-direct {p0, v1, v2}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->toLocalMotionEvent(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 1437
    iget v9, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I

    invoke-virtual {v1, v2, v9}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$DropDownListView;->onForwardedEvent(Landroid/view/MotionEvent;I)Z
...
.method private onTouchObserved(Landroid/view/MotionEvent;)Z
    ...
    iput v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I

    .line 1342
    iput-boolean v5, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mWasLongPress:Z

    .line 1344
    iget-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    if-nez v6, :cond_2

    .line 1345
    new-instance v6, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$DisallowIntercept;

    invoke-direct {v6, p0, v10}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$DisallowIntercept;-><init>(Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$1;)V

    iput-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    .line 1347
    :cond_2
    iget-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mDisallowIntercept:Ljava/lang/Runnable;

    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mTapTimeout:I
    ...
    .line 1348
    iget-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    if-nez v6, :cond_3

    .line 1349
    new-instance v6, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$TriggerLongPress;

    invoke-direct {v6, p0, v10}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener$TriggerLongPress;-><init>(Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$1;)V

    iput-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    .line 1351
    :cond_3
    iget-object v6, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mTriggerLongPress:Ljava/lang/Runnable;

    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mLongPressTimeout:I
    ...
    .line 1354
    :pswitch_1
    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mActivePointerId:I
    ...
    .line 1358
    .local v4, "y":F
    iget v7, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mScaledTouchSlop:F

    invoke-static {v2, v3, v4, v7}, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->pointInView(Landroid/view/View;FFF)Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 1272
    iget-boolean v2, p0, Lcn/nubia/commonui/actionbar/widget/ListPopupWindow$ForwardingListener;->mWasLongPress:Z
